          ...
          <div className="flex gap-2 md:gap-3 items-start">
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                className="w-full px-4 py-2.5 pl-11 pr-11 rounded-xl bg-slate-50 text-gray-800 placeholder:text-gray-400
                          ...
                          min-h-[44px] max-h-[200px] overflow-y-auto custom-input-scrollbar"
                rows={1}
                style={{ 
                  minHeight: '44px',
                  maxHeight: '200px',
              ...
              {/* 圖片上傳按鈕 - 左側 */}
              <label className="absolute left-3 top-[8px] p-1.5 rounded-lg hover:bg-slate-100 cursor-pointer transition-colors z-10">
              ...
              <button
                type="button"
                className="absolute right-3 top-[8px] p-1.5 rounded-lg hover:bg-slate-100 transition-colors z-10"
                onClick={() => {
                  // TODO: 實作語音輸入功能
                  alert('語音輸入功能開發中...');
                }}
