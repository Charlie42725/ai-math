...
export default function Login() {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 bg-[#221a3a] rounded-3xl flex flex-col items-center shadow-lg">
      <h2 className="text-4xl font-bold mb-8 text-center tracking-wide">登入</h2>
      ...
      <div className="w-full flex flex-col items-center mt-6">
        <div className="text-base text-[#e0e0e0] mb-2">還沒有帳戶？<a href="/signup" className="text-indigo-400 hover:underline ml-1">註冊</a></div>
